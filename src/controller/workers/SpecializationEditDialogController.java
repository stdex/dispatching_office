...
public class SpecializationEditDialogController {
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            try {
                if(obj.getId() != null) {
                    SpecializationOverviewController.tService.edit(obj);
                }
                else {
                    SpecializationOverviewController.tService.add(obj);
                }
