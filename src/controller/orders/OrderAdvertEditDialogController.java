...
public class OrderAdvertEditDialogController {
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            try {
                if(obj.getId() != null) {
                    OrderAdvertOverviewController.tService.edit(obj);
                }
                else {
                    OrderAdvertOverviewController.tService.add(obj);
                }
