...
public class OrderCategoryEditDialogController {
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            try {
                if(obj.getId() != null) {
                    OrderCategoryOverviewController.tService.edit(obj);
                }
                else {
                    OrderCategoryOverviewController.tService.add(obj);
                }
